  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'marketing-one': "url('/public/assets/images/png/read-more-one.png')",
        'marketing-two': "url('/public/assets/images/png/read-more-two.png')",
        'marketing-three': "url('/public/assets/images/png/read-more-three.png')",
        'mobile-marketing-one': "url('/public/assets/images/png/mobile-read-one.png')",
        'mobile-marketing-two': "url('/public/assets/images/png/mobile-read-two.png')",
        'mobile-marketing-three': "url('/public/assets/images/png/mobile-read-three.png')",
      },
    },
  },
  plugins: [],
