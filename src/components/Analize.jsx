...
const Analize = () => {
    return (
        <section style={{ backgroundImage: `url(/assets/images/png/Analyze-bg.png)` }} className="mt-20 max-xl:mt-12 max-sm:mt-8 bg-cover bg-no-repeat bg-center pt-16 pb-20 xl:px-32 max-sm:py-12 relative">
            <img
            ...
            <div className="container">
                <div className="md:flex justify-between max-lg:flex-col">
                    <div className="flex-col">
                        <p className="text-custom-xs font-normal leading-6 text-left pb-2 font-Mono max-lg:text-center">
                            Get a free competitive analysis on your market
                        </p>
                        <p className="text-custom-3xl font-light leading-none text-left max-lg:text-center max-sm:text-2xl">
