                ...
                <div className="flex justify-between flex-wrap max-xl:justify-center max-xl:gap-10">
                    ...
                    >
                        ...
                        <div className="bg-white mt-[35px]  px-[29px] pb-[31px] rounded-[25px]">
                            ...
                            <a
                                href="#"
                                className="flex items-center sm:pt-14 pt-6 font-semibold text-custom-xs max-sm:text-custom-xs"
                            >
                                Learn More
                                <svg
                                    className="ml-2"
                    ...
                    >
                        <p
                            className="text-custom-xs text-black z-[2] font-semibold absolute top-[5%] left-[15%] "
                        >
                            HVAC Marketing
                        </p>
                        <div className="bg-white mt-[35px]  px-[29px] pb-[31px] rounded-[25px]">
                            ...
                            <a
                                href="#"
                                className="flex items-center sm:pt-14 pt-6 font-semibold text-custom-xs"
                            >
                                Learn More
                                <svg
                                    className="ml-2"
                    ...
                    >
                        ...
                        <div className="bg-white mt-[35px] px-[29px] pb-[31px] rounded-[25px]">
                            ...
                            <a
                                href="#"
                                className="flex items-center sm:pt-12 pt-6 font-semibold text-custom-xs"
                            >
                                Learn More
                                <svg
                                    className="ml-2"
