    ...
    return (
        <div style={{ backgroundImage: `url(./assets/png/hero-bg.png)` }} className='bg-cover bg-no-repeat h-[869px] lg:bg-[100%_100%] max-sm:h-[539px] mx-w-[1440px] max-lg:pb-16 max-sm:pb-10'>
            ...
            <div className="container">
                ...
                <img className='ml-[273px] max-xl:ml-[200px] max-sm:ml-10 pointer-events-none' src="./assets/svg/green-line.svg" alt="line" />
                ...
                <form  className="border-2 border-white mt-7 text-white rounded-[50px] text-center py-4 sm:py-5 px-7 flex max-w-[448px] sm:mx-auto mx-5 justify-between">
                    <input
                        id="email"
                        type="text"
