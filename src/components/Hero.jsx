    ...
    return (
        <div style={{ backgroundImage: `url(./assets/images/webp/hero-bg.webp)` }} className='bg-cover bg-no-repeat h-[869px] lg:bg-[100%_100%] max-sm:h-[539px] mx-w-[1440px] max-lg:pb-16 max-sm:pb-10'>
            ...
            <div className="container">
                <h1 className='pt-[140px] max-sm:pt-[43px] font-sohne text-custom-9xl xl:leading-[104px] max-xl:text-custom-8xl leading-[97%] max-md:text-custom-5xl uppercase text-white max-w-[822px] mx-auto text-center'>Make marketing
                ...
                <form className="border-2 border-white mt-[30px] text-white rounded-[50px] text-center py-[22px] sm:py-5 px-6 flex max-w-[448px] sm:mx-auto mx-5 justify-between">
                    <input
                        id="email"
                        type="text"
