    ...
    return (
        <div style={{ backgroundImage: `url(./assets/images/png/hero-bg.png)` }} className='bg-cover bg-no-repeat h-[869px] lg:bg-[100%_100%] max-sm:h-[539px] mx-w-[1440px] max-lg:pb-16 max-sm:pb-10'>
            ...
            <div className="container">
                ...
                <img className='ml-[273px] max-xl:ml-[200px] max-sm:ml-10 pointer-events-none max-sm:max-w-[146px]' src="./assets/images/svg/green-line.svg" alt="line" />
                ...
                <form  className="border-2 border-white mt-[30px] text-white rounded-[50px] text-center py-4 sm:py-5 px-7 flex max-w-[448px] sm:mx-auto mx-5 justify-between">
                    <input
                        ...
                        className="bg-transparent outline-none flex-grow placeholder:text-light-gray text-light-gray text-custom-xs font-normal leading-5"
