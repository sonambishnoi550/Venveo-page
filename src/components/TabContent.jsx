                ...
                <div style={{ backgroundImage:`url(./assets/images/png/tab-one-bg.png)`}} className="relative bg-cover !max-w-[1280px] bg-center sm:px-20 sm:py-16 px-4 py-6 bg-no-repeat">
                    <div className="lg:flex justify-between">
                        <div className="lg:w-4/12">
                            ...
                            <p className="text-3xl font-light text-left text-white pb-8">
                                Answer our questions and listen to our answers.
                            </p>
                            <p className="font-normal text-custom-xs text-left text-white pb-[98px]">
                ...
                <div style={{ backgroundImage: `url(./assets/images/png/tab-three-bg.png)` }} className="max-w-[1280px] px-[79px] pt-[75px] h-[720px]">
                    <div className="lg:flex justify-between">
                        <div className="lg:w-5/12">
                            ...
                            <p className="text-3xl font-light text-left text-white leading-8 pt-28 pb-[14px]">
    ...
    return (
        <section className="py-14 flex justify-center">
            <div className="container max-w-[1280px] mx-auto">
                <h2 className="text-custom-7xl font-bold text-center uppercase sohne leading-[70px]">The Growth Partner</h2>
                <p className="text-3xl font-light text-center pb-[43px]">you’ve been looking for.</p>
                <p className="text-custom-xs font-normal text-center pb-[105px]">Businesses trust Venveo to power growth.</p>
                <div className="nav-tabs">
                    <div className="flex justify-center gap-20 pb-14 tab-list">
                        <p
                            className={`tab text-lg text-lightblack font-semibold cursor-pointer ${activeTab === "tab1" ? "!text-black opacity-100" : ""}`}
