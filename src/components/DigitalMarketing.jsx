    ...
    return (
        <section className="xl:pt-[132px] pt-24 relative min-h-screen max-sm:pt-[65px]">
            ...
            <div className="container max-w-[1140px] mx-auto">
                ...
                <h2 className="text-custom-7xl font-bold leading-[70px] max-sm:text-custom-5xl max-sm:leading-[52px] text-center mx-auto pt-[5px] uppercase sohne">
                ...
                <div className="lg:flex flex-wrap">
                    {CARD_LIST.map((card) => (
                        ...
                        >
                                ...
                                <div className="flex border-2 max-w-[503px] max-xl:max-w-[447px] max-sm:p-[30px] h-[506px] border-sky rounded-[25px] pt-[65px] pl-[30px] pr-[60px] pb-[54px] max-sm:pt-[34px] max-sm:pb-[36px] max-sm:px-[31px] relative z-10 bg-white md:gap-6">
                                    <img
                                        src={card.imgSrc}
                                        alt={card.imgAlt}
