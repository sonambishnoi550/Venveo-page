...
const MarketingSection = () => {
    ...
    return (
        <section className="sm:mt-32 mt-4 relative min-h-screen max-sm:pt-[65px]">
            <img
                src="./assets/images/png/digital-bg.png"
                alt="Background"
                className="absolute top-[23rem] max-sm:top-[21rem] w-full"
            />
            <div className="container max-w-[1140px] mx-auto">
                <p className="text-3xl font-light leading-8 text-center ">
                    Problems we solve.
                </p>
                <h2 className="text-custom-7xl font-bold leading-[101%] max-sm:text-custom-4xl text-center mx-auto pt-[5px] uppercase sohne">
                    Digital Marketing<br /> for today's Business
                </h2>
                <p className="text-custom-xs font-normal leading-5 text-center max-w-[641px] mx-auto pt-[22px] sm:pb-20 pb-20">
                ...
                <div className="lg:flex flex-wrap">
                    {CARD_LIST.map((card) => (
                        ...
                        >
                                ...
                                <div className="flex border-2 max-w-[503px] max-xl:max-w-[447px] max-sm:p-[30px] h-[506px] border-green rounded-[25px] pt-[65px] pl-[30px] pr-[60px] pb-[54px] max-sm:pt-[34px] max-sm:pb-[36px] max-sm:px-[31px] relative z-10 bg-white md:gap-6">
                                    <img
                                        src={card.imgSrc}
                                        alt={card.imgAlt}
                                        className="h-[53px] w-[53px] md:block hidden"
                                    />
                                    <div className="flex-col">
                                        <img
                                            src={card.imgSrc}
                                            alt={card.imgAlt}
                                            className=" max-sm:size-[38px] max-md:block hidden mb-2"
                                        />
                                        ...
                                        <p className="text-custom-xs font-semibold leading-5 text-left flex pt-5">
