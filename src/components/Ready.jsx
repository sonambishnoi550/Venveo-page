    ...
    >
      <div className="container">
        <div className="lg:flex justify-center">
          <p className="text-custom-3xl font-light leading-none text-center text-white pt-5 max-lg:pb-[30px] max-sm:text-3xl max-sm:max-w-[221px] max-sm:mx-auto font-maisonLight">
